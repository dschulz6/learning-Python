...
parser.add_argument("trip_record", help = "Perform calcs on Excel trip_records.xlsx",type=str)
...
row_count = 0
#
# ask user to for mileage spreadsheet called 
# custfile = input("What  mileage spreadsheet would you like to use: ") 
wb = openpyxl.load_workbook(args.trip_record)
#
